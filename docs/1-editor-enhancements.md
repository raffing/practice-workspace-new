# 🔵 Ramo 1 — Editor Enhancements

**Branch:** `feat/editor-enhancements`
...
- [ ] Folding (piega/espandi task)

## Sessione 4

- [ ] Menù contestuale avanzato nel pannello Workspace:
  - [ ] Crea nuova cartella nel filesystem
